...
/**
 * Named connection profiles: a saved set of fields (bridge WS, telepathosd HTTP,
...
object ConnectionProfiles {
    ...
    fun defaults() = Profile(
        ...
        telepathosd = "http://10.0.2.2:8790",
        token = "",
    )
            ...
            try {
                ...
                while (names.hasNext()) {
                    ...
                    out[name] = Profile(
                        ...
                        telepathosd = p.optString("telepathosd"),
    ...
    fun applyActive(ctx: Context) {
        ...
        ctx.getSharedPreferences("cfg", Context.MODE_PRIVATE).edit()
            ...
            .putString("hermes", p.telepathosd)
