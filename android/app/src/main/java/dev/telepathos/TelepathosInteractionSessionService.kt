 ...
 */
class TelepathosInteractionSessionService : VoiceInteractionSessionService() {
    override fun onNewSession(args: Bundle?): VoiceInteractionSession {
        Log.i("Telepathos", "SESSION CREATED — assist gesture reached us")
        return TelepathosInteractionSession(this)
    }
}

class TelepathosInteractionSession(context: android.content.Context) : VoiceInteractionSession(context) {
    ...
    override fun onShow(args: Bundle?, showFlags: Int) {
        ...
        lastPinch = now
        Log.i("Telepathos", "pinch (meta=$isMeta)")
