...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var telepathosdInput: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // header + phase
        col.addView(label("TELEPATHOS", 18f, Color.BLACK))
        ...
        telepathosdInput.setText(getSharedPreferences("cfg", MODE_PRIVATE).getString("hermes", ""))
    ...
    private fun loadProfiles() {
        ...
        telepathosdInput.setText(p.telepathosd)
    ...
    private fun saveCurrentInto(name: String) {
        profiles[name] = ConnectionProfiles.Profile(
            ...
            telepathosd = telepathosdInput.text.toString().trim(),
    ...
    private fun saveUrl(): Boolean {
        ...
        getSharedPreferences("cfg", MODE_PRIVATE).edit()
            ...
            .putString("hermes", telepathosdInput.text.toString().trim())
    ...
    /** Lane list from telepathosd; tap the block to cycle to the next lane. */
            ...
            runOnUiThread {
                when (result) {
                    is LaneStore.LaneStateResult.NotConfigured -> {
                        ...
                        lanesView.text = "(no telepathosd URL configured)"
                    }
