...
internal object HttpResponseLimits {
    /** Matches Node's TELEPATHYD_STATE_RESPONSE_MAX_BYTES bounded registry response. */
    ...
    /** telepathyd bounds serialized pending deliveries at 8 MiB, plus its envelope. */
